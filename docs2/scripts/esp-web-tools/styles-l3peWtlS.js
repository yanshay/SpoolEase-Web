...
const r$5 = t => new n$3("string" == typeof t ? t : t + "", void 0, s$1),
  i$4 = (t, ...e) => {
...
const t$2 = globalThis,
  ...
  s = i$2 ? i$2.createPolicy("lit-html", {
    createHTML: t => t
  }) : void 0,
  e$4 = "$lit$",
...
function S(t, i, s = t, e) {
  ...
  return ((_h = h) === null || _h === void 0 ? void 0 : _h.constructor) !== o && ((_h2 = h) !== null && _h2 !== void 0 && (_h2$_$AO = _h2._$AO) !== null && _h2$_$AO !== void 0 && _h2$_$AO.call(_h2, !1), void 0 === o ? h = void 0 : (h = new o(t), h._$AT(t, s, e)), void 0 !== e ? (s._$Co ?? (s._$Co = []))[e] = h : s._$Cl = h), void 0 !== h && (i = S(t, h._$AS(t, i.values), h, e)), i;
}
class M {
  constructor(t, i) {
...
class R {
  ...
  constructor(t, i, s, e) {
    this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t, this._$AB = i, this._$AM = s, this.options = e, this._$Cv = (e === null || e === void 0 ? void 0 : e.isConnected) ?? !0;
  }
  get parentNode() {
    var _t;
...
j !== null && j !== void 0 && j(N, R), (t$2.litHtmlVersions ?? (t$2.litHtmlVersions = [])).push("3.2.1");
const B = (t, i, s) => {
...
r$2._$litElement$ = !0, r$2["finalized"] = !0, (_globalThis$litElemen = globalThis.litElementHydrateSupport) === null || _globalThis$litElemen === void 0 ? void 0 : _globalThis$litElemen.call(globalThis, {
  LitElement: r$2
});
const i$1 = globalThis.litElementPolyfillSupport;
i$1 === null || i$1 === void 0 || i$1({
  LitElement: r$2
});
...
const buttonBaseClass = mixinDelegatesAria(mixinElementInternals(r$2));
/**
 * A button component.
 */
 ...
 */
// Separate variable needed for closure.
const dialogBaseClass = mixinDelegatesAria(r$2);
/**
 * A dialog component.
 *
...
export { B, Divider as D, E, T, __decorate as _, e$2 as a, e as b, internals as c, mixinElementInternals as d, e$3 as e, r as f, isActivationClick as g, dispatchActivationClick as h, i$4 as i, redispatchEvent as j, setupFormSubmitter as k, EASING as l, mixinDelegatesAria as m, n, o, e$1 as p, i as q, r$2 as r, styles$1 as s, t$1 as t, t as u, createAnimationSignal as v, b as w, x, dialogStyles as y };
